...
$(document).ready(function () {
    ...
    // $('#ta').val('setting it to sanket');
    // $('#ta').html('setting it to sanket');
    // $('#ta').html('setting it to sanket3');
    // $('#inp').html('setting it to sanket3');
    // $('#inp').val('setting it to sanket3');
    // $('#inp').empty()
    // $('#wiki').empty()
    ...
    //     { name: 'sanket', channel: 'code with sanket' },
